...
export default class AdicionarLivros extends Component{
    state = {...initialState}
    save = ()=>{
        ...
        return(
            <Modal onRequestClose={this.props.onCancel}
                ...
                <View style={styles.container}>
                    <Text style={styles.header}>Novo livro para cadastro</Text>
                    <TextInput placeholder="Nome do Livro" style={styles.input}
